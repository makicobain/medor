  ...
  return (
    <div className="min-h-screen bg-bg pb-24">
      ...
      <div className="px-5 pt-4 lg:px-0 lg:pt-0">
        <h1 className="text-[28px] font-semibold text-text leading-tight">Carte des emplacements</h1>
        <p className="text-muted text-sm mt-1 mb-4">1074 sites répertoriés</p>
